package net.kuma.tutorialmod.item;
...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_ITEM_TAB = CREATIVE_MODE_TAB.register("bismuth_items_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BISMUTH.get()))
                    .title(Component.translatable("creativetab.tutorialmod.bismuth.items"))
    ...
    public static final Supplier<CreativeModeTab> BISMUTH_BLOCK_TAB = CREATIVE_MODE_TAB.register("bismuth_blocks_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.BISMUTH_BLOCK))
                    ...
                    .title(Component.translatable("creativetab.tutorialmod.bismuth.blocks"))
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModBlocks.BISMUTH_STAIR);
