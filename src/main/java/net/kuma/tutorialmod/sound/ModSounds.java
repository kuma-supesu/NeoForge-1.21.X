package net.kuma.tutorialmod.sound;
...
public class ModSounds {
    ...
    public static final Supplier<SoundEvent> MAGIC_BLOCK_BREAK = registerSoundEvent("magic_bloc_break");
    public static final Supplier<SoundEvent> MAGIC_BLOCK_STEP = registerSoundEvent("magic_bloc_step");
